...
menuList.showFractionKeyMenu = function(data) {
    ...
    data.forEach(function (item) {
        ...
        if (item.rank >= user.getCache('rank1') || user.isLeader() || user.isSubLeader()) {
            let menuItem = {};
...
menuList.showFractionInfoMenu = function() {
    ...
    if (user.isLeader() || user.isSubLeader() || ((user.isDepLeader() || user.isDepSubLeader()) && user.getCache('rank_type1') === 0))
...
menuList.showFractionInvaderMenu = function() {
    ...
    if (user.isLeader() || user.isSubLeader() || user.getCache('rank_type1') > 0) {
        UIMenu.Menu.AddMenuItem(`Список объявлений`, "", {adList: true});
        UIMenu.Menu.AddMenuItem(`Список всех объявлений`, "", {adListAll: true});
    }
    if (user.isLeader() || user.isSubLeader() || user.getCache('rank_type1') === 2) {
...
menuList.showEmsArsenalMenu = function() {
    ...
    if (user.getCache('rank_type1') !== 0 || user.isLeader() || user.isSubLeader() || user.isDepLeader() || user.isDepSubLeader()) {
...
menuList.showSheriffArsenalMenu = function() {
    ...
    if (user.getCache('rank_type1') !== 0 || user.isLeader() || user.isSubLeader() || user.isDepLeader() || user.isSubLeader()) {
        UIMenu.Menu.AddMenuItem("Большая Аптечка", "", {itemId: 278});
        UIMenu.Menu.AddMenuItem("Полицейское огорождение", "", {itemId: 199});
        UIMenu.Menu.AddMenuItem("Полосатый конус", "", {itemId: 201});
        UIMenu.Menu.AddMenuItem("Красный конус", "", {itemId: 202});
...
menuList.showSheriffArsenalGunMenu = function() {
    ...
    if (user.getCache('rank_type1') === 0) {
        UIMenu.Menu.AddMenuItem("Beretta 90Two", "", {itemId: 78});
        UIMenu.Menu.AddMenuItem("Коробка патронов 9mm", "", {itemId: 280});
    }
    if (user.getCache('rank_type1') === 1 || user.getCache('rank_type1') === 2 || user.getCache('rank_type1') === 3 || user.getCache('rank_type1') === 4) {
        UIMenu.Menu.AddMenuItem("Beretta 90Two", "", {itemId: 78});
    ...
    if (user.getCache('rank_type1') === 6 || user.isLeader() || user.isSubLeader() || user.isDepLeader() || user.isDepSubLeader()) {
        UIMenu.Menu.AddMenuItem("Beretta 90Two", "", {itemId: 78});
        UIMenu.Menu.AddMenuItem("Glock 17", "", {itemId: 146});
        UIMenu.Menu.AddMenuItem("Benelli M3", "", {itemId: 90});
        UIMenu.Menu.AddMenuItem("Benelli M4", "", {itemId: 91});
...
menuList.showSheriffArsenalGunModMenu = function() {
    ...
    else if (user.getCache('rank_type1') === 5) {
        UIMenu.Menu.AddMenuItem("Фонарик Beretta 90Two", "", {itemId: 311});
        UIMenu.Menu.AddMenuItem("Оптический прицел Beretta 90Two", "", {itemId: 312});
        UIMenu.Menu.AddMenuItem("Глушитель Beretta 90Two", "", {itemId: 313});
        UIMenu.Menu.AddMenuItem("Компенсатор Beretta 90Two", "", {itemId: 314});
    ...
    else if (user.getCache('rank_type1') === 6 || user.isLeader() || user.isSubLeader() || user.isDepLeader() || user.isDepSubLeader()) {
        UIMenu.Menu.AddMenuItem("Фонарик Beretta 90Two", "", {itemId: 311});
        UIMenu.Menu.AddMenuItem("Оптический прицел Beretta 90Two", "", {itemId: 312});
        UIMenu.Menu.AddMenuItem("Глушитель Beretta 90Two", "", {itemId: 313});
        UIMenu.Menu.AddMenuItem("Компенсатор Beretta 90Two", "", {itemId: 314});
...
menuList.showSapdClearMenu = function() {
    if (!user.isLeader() && !user.isSubLeader()) {
        if (user.getCache('rank1') > 1 && user.getCache('rank_type1') === 0) {
...
menuList.showSapdArsenalGunMenu = function() {
    ...
    if (user.getCache('rank_type1') === 1 || user.getCache('rank_type1') === 6 || user.getCache('rank_type1') === 10 || user.getCache('rank_type1') === 7 || user.getCache('rank_type1') === 2) {
        UIMenu.Menu.AddMenuItem("Beretta 90Two", "", {itemId: 78});
        UIMenu.Menu.AddMenuItem("Glock 17", "", {itemId: 146});
        UIMenu.Menu.AddMenuItem("Benelli M3", "", {itemId: 90});
        UIMenu.Menu.AddMenuItem("Benelli M4", "", {itemId: 91});
    ...
    if (user.getCache('rank_type1') === 3 || user.getCache('rank_type1') === 5 || user.getCache('rank_type1') === 8) {
        UIMenu.Menu.AddMenuItem("Beretta 90Two", "", {itemId: 78});
        UIMenu.Menu.AddMenuItem("Glock 17", "", {itemId: 146});
        UIMenu.Menu.AddMenuItem("MP5A3", "", {itemId: 103});
    ...
    if (user.getCache('rank_type1') === 4 || user.getCache('rank_type1') === 9 || user.isLeader() || user.isSubLeader() || user.isDepLeader() || user.isDepSubLeader()) {
        UIMenu.Menu.AddMenuItem("Beretta 90Two", "", {itemId: 78});
        UIMenu.Menu.AddMenuItem("Glock 17", "", {itemId: 146});
        UIMenu.Menu.AddMenuItem("Benelli M3", "", {itemId: 90});
        UIMenu.Menu.AddMenuItem("Benelli M4", "", {itemId: 91});
...
menuList.showSapdArsenalGunModMenu = function() {
    ...
    else if (user.getCache('rank_type1') === 3 || user.getCache('rank_type1') === 5 || user.getCache('rank_type1') === 8) {
        UIMenu.Menu.AddMenuItem("Фонарик Beretta 90Two", "", {itemId: 311});
        UIMenu.Menu.AddMenuItem("Оптический прицел Beretta 90Two", "", {itemId: 312});
        UIMenu.Menu.AddMenuItem("Глушитель Beretta 90Two", "", {itemId: 313});
        UIMenu.Menu.AddMenuItem("Компенсатор Beretta 90Two", "", {itemId: 314});
    ...
    else if (user.getCache('rank_type1') === 4 || user.getCache('rank_type1') === 9 || user.isLeader() || user.isSubLeader() || user.isDepLeader() || user.isDepSubLeader()) {
        UIMenu.Menu.AddMenuItem("Фонарик Beretta 90Two", "", {itemId: 311});
        UIMenu.Menu.AddMenuItem("Оптический прицел Beretta 90Two", "", {itemId: 312});
        UIMenu.Menu.AddMenuItem("Глушитель Beretta 90Two", "", {itemId: 313});
        UIMenu.Menu.AddMenuItem("Компенсатор Beretta 90Two", "", {itemId: 314});
...
menuList.showUsmcArsenalGunMenu = function() {
    ...
    if (user.getCache('rank_type1') === 1 || user.getCache('rank_type1') === 2) {
        UIMenu.Menu.AddMenuItem("Beretta 90Two", "", {itemId: 78});
        UIMenu.Menu.AddMenuItem("Glock 17", "", {itemId: 146});
        UIMenu.Menu.AddMenuItem("Benelli M3", "", {itemId: 90});
        UIMenu.Menu.AddMenuItem("Benelli M4", "", {itemId: 91});
    ...
    if (user.getCache('rank_type1') === 4 || user.isLeader() || user.isSubLeader() || user.isDepLeader() || user.isDepSubLeader()) {
        UIMenu.Menu.AddMenuItem("Beretta 90Two", "", {itemId: 78});
        UIMenu.Menu.AddMenuItem("Glock 17", "", {itemId: 146});
...
menuList.showUsmcArsenalGunModMenu = function() {
    ...
    else if (user.getCache('rank_type1') === 3) {
        UIMenu.Menu.AddMenuItem("Фонарик Beretta 90Two", "", {itemId: 311});
        UIMenu.Menu.AddMenuItem("Оптический прицел Beretta 90Two", "", {itemId: 312});
        UIMenu.Menu.AddMenuItem("Глушитель Beretta 90Two", "", {itemId: 313});
        UIMenu.Menu.AddMenuItem("Компенсатор Beretta 90Two", "", {itemId: 314});
    ...
    else if (user.getCache('rank_type1') === 4 || user.isLeader() || user.isSubLeader() || user.isDepLeader() || user.isDepSubLeader()) {
        UIMenu.Menu.AddMenuItem("Фонарик Beretta 90Two", "", {itemId: 311});
        UIMenu.Menu.AddMenuItem("Оптический прицел Beretta 90Two", "", {itemId: 312});
        UIMenu.Menu.AddMenuItem("Глушитель Beretta 90Two", "", {itemId: 313});
        UIMenu.Menu.AddMenuItem("Компенсатор Beretta 90Two", "", {itemId: 314});
...
menuList.showFibArsenalGunMenu = function() {
    ...
    if (user.getCache('rank_type1') === 2 || user.getCache('rank_type1') === 1 || user.isLeader() || user.isSubLeader() || user.isDepLeader() || user.isDepSubLeader()) {
        UIMenu.Menu.AddMenuItem("Beretta 90Two", "", {itemId: 78});
        UIMenu.Menu.AddMenuItem("Glock 17", "", {itemId: 146});
        UIMenu.Menu.AddMenuItem("Benelli M3", "", {itemId: 90});
        UIMenu.Menu.AddMenuItem("Benelli M4", "", {itemId: 91});
...
menuList.showFibArsenalGunModMenu = function() {
    UIMenu.Menu.Create(`Арсенал`, `~b~Модули на оружие`);
    if (user.getCache('rank_type1') === 1 || user.getCache('rank_type1') === 2 || user.isLeader() || user.isSubLeader() || user.isDepLeader() || user.isDepSubLeader()) {
        UIMenu.Menu.AddMenuItem("Фонарик Beretta 90Two", "", {itemId: 311});
        UIMenu.Menu.AddMenuItem("Оптический прицел Beretta 90Two", "", {itemId: 312});
        UIMenu.Menu.AddMenuItem("Глушитель Beretta 90Two", "", {itemId: 313});
        UIMenu.Menu.AddMenuItem("Компенсатор Beretta 90Two", "", {itemId: 314});
